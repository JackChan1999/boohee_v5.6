...
final class FragmentManagerImpl extends FragmentManager implements LayoutInflaterFactory {
    ...
    L_0x0028:
        monitor-enter(r8);
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x009c }
    ...
    L_0x005c:
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x009c }
        r4 = r5.size();	 Catch:{ all -> 0x009c }
        r5 = r8.mTmpActions;	 Catch:{ all -> 0x009c }
        if (r5 == 0) goto L_0x006b;
    L_0x0066:
        r5 = r8.mTmpActions;	 Catch:{ all -> 0x009c }
        r5 = r5.length;	 Catch:{ all -> 0x009c }
        if (r5 >= r4) goto L_0x006f;
    L_0x006b:
        r5 = new java.lang.Runnable[r4];	 Catch:{ all -> 0x009c }
        r8.mTmpActions = r5;	 Catch:{ all -> 0x009c }
    L_0x006f:
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x009c }
        r6 = r8.mTmpActions;	 Catch:{ all -> 0x009c }
        r5.toArray(r6);	 Catch:{ all -> 0x009c }
        r5 = r8.mPendingActions;	 Catch:{ all -> 0x009c }
        r5.clear();	 Catch:{ all -> 0x009c }
        r5 = r8.mHost;	 Catch:{ all -> 0x009c }
        r5 = r5.getHandler();	 Catch:{ all -> 0x009c }
        r6 = r8.mExecCommit;	 Catch:{ all -> 0x009c }
        r5.removeCallbacks(r6);	 Catch:{ all -> 0x009c }
        monitor-exit(r8);	 Catch:{ all -> 0x009c }
        r5 = 1;
