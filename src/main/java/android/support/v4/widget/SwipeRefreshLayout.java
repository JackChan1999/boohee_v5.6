...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    private void moveSpinner(float overscrollTop) {
        ...
        float adjustedPercent = (((float) Math.max(((double) dragPercent) - 0.4d, 0.0d)) * 5.0f) / IPhotoView.DEFAULT_MAX_SCALE;
        ...
        float tensionPercent = ((float) (((double) (tensionSlingshotPercent / aj.hA)) - Math.pow((double) (tensionSlingshotPercent / aj.hA), PathListView.ZOOM_X2))) * DECELERATE_INTERPOLATION_FACTOR;
