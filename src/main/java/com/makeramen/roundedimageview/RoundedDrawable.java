...
public class RoundedDrawable extends Drawable {
    ...
    private void updateShaderMatrix() {
        ...
        switch (AnonymousClass1.$SwitchMap$android$widget$ImageView$ScaleType[this.mScaleType
            ...
            case 1:
                ...
                this.mShaderMatrix.setTranslate((float) ((int) (((this.mBorderRect.width() - (
                        (float) this.mBitmapWidth)) * 0.5f) + 0.5f)), (float) ((int) (((this
                        .mBorderRect.height() - ((float) this.mBitmapHeight)) * 0.5f) + 0.5f)));
                break;
            case 2:
                this.mBorderRect.set(this.mBounds);
                this.mBorderRect.inset(this.mBorderWidth / 2.0f, this.mBorderWidth / 2.0f);
                ...
                dx = 0.0f;
                dy = 0.0f;
                if (((float) this.mBitmapWidth) * this.mBorderRect.height() > this.mBorderRect
                        .width() * ((float) this.mBitmapHeight)) {
                    ...
                    dy = (this.mBorderRect.height() - (((float) this.mBitmapHeight) * scale)) * 0
                    .5f;
                }
                this.mShaderMatrix.setScale(scale, scale);
                this.mShaderMatrix.postTranslate(((float) ((int) (dx + 0.5f))) + (this
                        .mBorderWidth / 2.0f), ((float) ((int) (dy + 0.5f))) + (this.mBorderWidth
                        / 2.0f));
                break;
            case 3:
                this.mShaderMatrix.reset();
                if (((float) this.mBitmapWidth) > this.mBounds.width() || ((float) this
                        .mBitmapHeight) > this.mBounds.height()) {
                    scale = Math.min(this.mBounds.width() / ((float) this.mBitmapWidth), this
                            .mBounds.height() / ((float) this.mBitmapHeight));
                } else {
                    scale = 1.0f;
                }
                dx = (float) ((int) (((this.mBounds.width() - (((float) this.mBitmapWidth) *
                        scale)) * 0.5f) + 0.5f));
                dy = (float) ((int) (((this.mBounds.height() - (((float) this.mBitmapHeight) *
                        scale)) * 0.5f) + 0.5f));
                this.mShaderMatrix.setScale(scale, scale);
                ...
                this.mBorderRect.inset(this.mBorderWidth / 2.0f, this.mBorderWidth / 2.0f);
                this.mShaderMatrix.setRectToRect(this.mBitmapRect, this.mBorderRect, ScaleToFit
                        .FILL);
                break;
            case 5:
                this.mBorderRect.set(this.mBitmapRect);
    ...
    private void redrawBorderForSquareCorners(Canvas canvas) {
        if (!all(this.mCornersRounded) && this.mCornerRadius != 0.0f) {
            ...
            if (!this.mCornersRounded[2]) {
                canvas.drawLine((right - radius) - offset, bottom, right + offset, bottom, this
                        .mBorderPaint);
