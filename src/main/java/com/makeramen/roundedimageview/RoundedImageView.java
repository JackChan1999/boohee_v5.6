...
public class RoundedImageView extends ImageView {
    ...
    private static final ScaleType[] SCALE_TYPES          = new ScaleType[]{ScaleType.MATRIX,
    ...
    public void setCornerRadius(float topLeft, float topRight, float bottomLeft, float
            bottomRight) {
        if (this.mCornerRadii[0] != topLeft || this.mCornerRadii[1] != topRight || this
                .mCornerRadii[2] != bottomRight || this.mCornerRadii[3] != bottomLeft) {
