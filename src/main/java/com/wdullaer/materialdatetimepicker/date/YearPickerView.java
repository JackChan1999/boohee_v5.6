...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    private class YearAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            TextViewWithCircularIndicator v = (TextViewWithCircularIndicator) super.getView
                    (position, convertView, parent);
            v.setAccentColor(YearPickerView.this.mController.getAccentColor());
            v.requestLayout();
            boolean selected = YearPickerView.this.mController.getSelectedDay().year ==
                    YearPickerView.getYearFromTextView(v);
    ...
    private void init(Context context) {
        ...
        for (int year = this.mController.getMinYear(); year <= this.mController.getMaxYear();
             year++) {
    ...
    public void onDateChanged() {
        this.mAdapter.notifyDataSetChanged();
        postSetSelectionCentered(this.mController.getSelectedDay().year - this.mController
                .getMinYear());
    }
