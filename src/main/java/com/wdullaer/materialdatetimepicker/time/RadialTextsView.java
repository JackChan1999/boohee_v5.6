...
public class RadialTextsView extends View {
    ...
    public void onDraw(Canvas canvas) {
        if (getWidth() != 0 && this.mIsInitialized) {
            if (!this.mDrawValuesReady) {
                ...
                this.mCircleRadius = ((float) Math.min(this.mXCenter, this.mYCenter)) * this
                        .mCircleRadiusMultiplier;
                if (!this.mIs24HourMode) {
                    this.mYCenter = (int) (((double) this.mYCenter) - (((double) (this
                            .mCircleRadius * this.mAmPmCircleRadiusMultiplier)) * 0.75d));
                }
            ...
            if (this.mTextGridValuesDirty) {
                calculateGridSizes((this.mCircleRadius * this.mNumbersRadiusMultiplier) * this
                        .mAnimationRadiusMultiplier, (float) this.mXCenter, (float) this
                        .mYCenter, this.mTextSize, this.mTextGridHeights, this.mTextGridWidths);
                if (this.mHasInnerCircle) {
                    calculateGridSizes((this.mCircleRadius * this.mInnerNumbersRadiusMultiplier)
                            * this.mAnimationRadiusMultiplier, (float) this.mXCenter, (float)
                            this.mYCenter, this.mInnerTextSize, this.mInnerTextGridHeights, this
                            .mInnerTextGridWidths);
                }
                this.mTextGridValuesDirty = false;
            }
            drawTexts(canvas, this.mTextSize, this.mTypefaceLight, this.mTexts, this
                    .mTextGridWidths, this.mTextGridHeights);
            if (this.mHasInnerCircle) {
                drawTexts(canvas, this.mInnerTextSize, this.mTypefaceRegular, this.mInnerTexts,
                        this.mInnerTextGridWidths, this.mInnerTextGridHeights);
            }
        }
    }

    private void calculateGridSizes(float numbersRadius, float xCenter, float yCenter, float
            textSize, float[] textGridHeights, float[] textGridWidths) {
    ...
    private void drawTexts(Canvas canvas, float textSize, Typeface typeface, String[] texts,
        ...
        canvas.drawText(texts[0], textGridWidths[3], textGridHeights[0], Integer.parseInt
                (texts[0]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[1], textGridWidths[4], textGridHeights[1], Integer.parseInt
                (texts[1]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[2], textGridWidths[5], textGridHeights[2], Integer.parseInt
                (texts[2]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[3], textGridWidths[6], textGridHeights[3], Integer.parseInt
                (texts[3]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[4], textGridWidths[5], textGridHeights[4], Integer.parseInt
                (texts[4]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[5], textGridWidths[4], textGridHeights[5], Integer.parseInt
                (texts[5]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[6], textGridWidths[3], textGridHeights[6], Integer.parseInt
                (texts[6]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[7], textGridWidths[2], textGridHeights[5], Integer.parseInt
                (texts[7]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[8], textGridWidths[1], textGridHeights[4], Integer.parseInt
                (texts[8]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[9], textGridWidths[0], textGridHeights[3], Integer.parseInt
                (texts[9]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[10], textGridWidths[1], textGridHeights[2], Integer.parseInt
                (texts[10]) == this.selection ? this.mSelectedPaint : this.mPaint);
        canvas.drawText(texts[11], textGridWidths[2], textGridHeights[1], Integer.parseInt
                (texts[11]) == this.selection ? this.mSelectedPaint : this.mPaint);
    }
