...
public class RadialSelectorView extends View {
    ...
    public void initialize(Context context, TimePickerController controller, boolean
            hasInnerCircle, boolean disappearsOut, int selectionDegrees, boolean isInnerCircle) {
        int i = -1;
        ...
        if (hasInnerCircle) {
            ...
            this.mOuterNumbersRadiusMultiplier = Float.parseFloat(res.getString(R.string
        ...
        this.mSelectionRadiusMultiplier = Float.parseFloat(res.getString(R.string
                .mdtp_selection_radius_multiplier));
    ...
    public int getDegreesFromCoords(float pointX, float pointY, boolean forceLegal, Boolean[]
            isInnerCircle) {
        if (!this.mDrawValuesReady) {
            return -1;
        }
        double hypotenuse = Math.sqrt((double) (((pointY - ((float) this.mYCenter)) * (pointY - (
                (float) this.mYCenter))) + ((pointX - ((float) this.mXCenter)) * (pointX - (
                (float) this.mXCenter)))));
        if (this.mHasInnerCircle) {
            if (forceLegal) {
                boolean z;
                if (((int) Math.abs(hypotenuse - ((double) ((int) (((float) this.mCircleRadius) *
                        this.mInnerNumbersRadiusMultiplier))))) <= ((int) Math.abs(hypotenuse - (
                        (double) ((int) (((float) this.mCircleRadius) * this
                ...
                int maxAllowedHypotenuseForOuterNumber = ((int) (((float) this.mCircleRadius) *
                        this.mOuterNumbersRadiusMultiplier)) + this.mSelectionRadius;
                int halfwayHypotenusePoint = (int) (((float) this.mCircleRadius) * ((this
                        .mOuterNumbersRadiusMultiplier + this.mInnerNumbersRadiusMultiplier) / 2
                .0f));
                if (hypotenuse >= ((double) (((int) (((float) this.mCircleRadius) * this
                        .mInnerNumbersRadiusMultiplier)) - this.mSelectionRadius)) && hypotenuse
                        <= ((double) halfwayHypotenusePoint)) {
                    isInnerCircle[0] = Boolean.valueOf(true);
                } else if (hypotenuse > ((double) maxAllowedHypotenuseForOuterNumber) ||
                        hypotenuse < ((double) halfwayHypotenusePoint)) {
                    return -1;
                } else {
                    isInnerCircle[0] = Boolean.valueOf(false);
                }
            }
        } else if (!forceLegal && ((int) Math.abs(hypotenuse - ((double) this.mLineLength))) > (
                (int) (((float) this.mCircleRadius) * (1.0f - this.mNumbersRadiusMultiplier)))) {
            return -1;
        }
        int degrees = (int) ((180.0d * Math.asin(((double) Math.abs(pointY - ((float) this
                .mYCenter))) / hypotenuse)) / 3.141592653589793d);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (getWidth() != 0 && this.mIsInitialized) {
            if (!this.mDrawValuesReady) {
                ...
                this.mSelectionRadius = (int) (((float) this.mCircleRadius) * this
                        .mSelectionRadiusMultiplier);
                this.mDrawValuesReady = true;
            }
            this.mLineLength = (int) ((((float) this.mCircleRadius) * this
                    .mNumbersRadiusMultiplier) * this.mAnimationRadiusMultiplier);
            int pointX = this.mXCenter + ((int) (((double) this.mLineLength) * Math.sin(this
                    .mSelectionRadians)));
            int pointY = this.mYCenter - ((int) (((double) this.mLineLength) * Math.cos(this
                    .mSelectionRadians)));
            this.mPaint.setAlpha(this.mSelectionAlpha);
            canvas.drawCircle((float) pointX, (float) pointY, (float) this.mSelectionRadius, this
                    .mPaint);
            ...
            if ((i | z) != 0) {
                ...
                canvas.drawCircle((float) pointX, (float) pointY, (float) ((this.mSelectionRadius
                        * 2) / 7), this.mPaint);
            } else {
                int lineLength = this.mLineLength - this.mSelectionRadius;
                pointX = this.mXCenter + ((int) (((double) lineLength) * Math.sin(this
                        .mSelectionRadians)));
                pointY = this.mYCenter - ((int) (((double) lineLength) * Math.cos(this
                        .mSelectionRadians)));
            }
            this.mPaint.setAlpha(255);
            this.mPaint.setStrokeWidth(aj.hA);
            canvas.drawLine((float) this.mXCenter, (float) this.mYCenter, (float) pointX, (float)
                    pointY, this.mPaint);
        }
    }
