...
public abstract class c {
    protected static String a(String str) {
        ...
        try {
            ...
            HttpURLConnection httpURLConnection3 = (HttpURLConnection) new URL(str)
                    .openConnection();
            try {
                ...
                if (httpURLConnection3.getResponseCode() == 200) {
                    ...
                    Object headerField = httpURLConnection3.getHeaderField(AsyncHttpClient
                            .HEADER_CONTENT_ENCODING);
                    if (!TextUtils.isEmpty(headerField) && headerField.equalsIgnoreCase
                            (AsyncHttpClient.ENCODING_GZIP)) {
                        b.a(a.e, nextInt + "  Use GZIPInputStream get data....");
                        gZIPInputStream = new GZIPInputStream(inputStream);
                    } else if (TextUtils.isEmpty(headerField) || !headerField.equalsIgnoreCase
                            ("deflate")) {
        ...
        try {
            ...
            try {
                ...
                if (httpURLConnection2.getResponseCode() == 200) {
                    ...
                    Object headerField = httpURLConnection2.getHeaderField(AsyncHttpClient
                            .HEADER_CONTENT_ENCODING);
                    if (TextUtils.isEmpty(headerField) || !headerField.equalsIgnoreCase
                            (AsyncHttpClient.ENCODING_GZIP)) {
