...
public abstract class f {
    ...
    protected static String[] a(Context context, String str, UMPlatformData... uMPlatformDataArr)
            throws a {
        ...
        if (TextUtils.isEmpty(obj)) {
            try {
                ...
                if (applicationInfo != null) {
                    ...
                    b.b(com.umeng.analytics.a.e, "Could not read UMENG_APPKEY meta-data from " +
                            "AndroidManifest.xml.");
                }
            } catch (Exception e) {
                b.b(com.umeng.analytics.a.e, "Could not read UMENG_APPKEY meta-data from " +
    ...
    private static String d(Context context) {
        try {
            ...
            b.e(com.umeng.analytics.a.e, "Could not get mac address.[no permission android" +
