    ...
    public static class a {
        ...
        public void a(byte[] bArr) {
            ...
            if (bArr != null && bArr.length != 0) {
                try {
                    bu.a(new File(this.b, String.format(Locale.US, "um_cache_%d.env", new
                            Object[]{Long.valueOf(System.currentTimeMillis())})), bArr);
                } catch (Exception e) {
                }
                File[] listFiles = this.b.listFiles(this.c);
