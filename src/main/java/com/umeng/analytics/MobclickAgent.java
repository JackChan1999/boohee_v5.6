...
public class MobclickAgent {
    ...
    public static void onEventDuration(Context context, String str, Map<String, String> map, long
            j) {
        if (j <= 0) {
            bv.c("duration is not valid in onEventDuration");
        } else if (map == null) {
    ...
    public static void onSocialEvent(Context context, String str, UMPlatformData...
            uMPlatformDataArr) {
        if (context == null) {
