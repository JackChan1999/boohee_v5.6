...
public class MobclickAgentJSInterface {
    ...
    final class a extends WebChromeClient {
        ...
        public a(MobclickAgentJSInterface mobclickAgentJSInterface, WebChromeClient
                webChromeClient) {
        ...
        public boolean onJsBeforeUnload(WebView webView, String str, String str2, JsResult
                jsResult) {
    ...
    public MobclickAgentJSInterface(Context context, WebView webView, WebChromeClient
            webChromeClient) {
        this.a = context;
        webView.getSettings().setJavaScriptEnabled(true);
