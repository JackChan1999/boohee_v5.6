...
public class FlipLoadingLayout extends LoadingLayout {
    ...
    public FlipLoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray
            attrs) {
        ...
        this.mResetRotateAnimation = new RotateAnimation((float) rotateAngle, 0.0f, 1, 0.5f, 1, 0
        .5f);
    ...
    protected void onLoadingDrawableSet(Drawable imageDrawable) {
        if (imageDrawable != null) {
            ...
            matrix.postTranslate(((float) (lp.width - dWidth)) / 2.0f, ((float) (lp.height -
                    dHeight)) / 2.0f);
            matrix.postRotate(getDrawableRotationAngle(), ((float) lp.width) / 2.0f, ((float) lp
                    .height) / 2.0f);
