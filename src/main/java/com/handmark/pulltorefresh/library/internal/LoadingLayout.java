...
public abstract class LoadingLayout extends FrameLayout implements ILoadingLayout {
    ...
    public LoadingLayout(Context context, Mode mode, Orientation scrollDirection, TypedArray
            attrs) {
        ...
        this.mHeaderProgress = (ProgressBar) this.mInnerLayout.findViewById(R.id
                .pull_to_refresh_progress);
        this.mSubHeaderText = (TextView) this.mInnerLayout.findViewById(R.id
        ...
        switch (mode) {
            case PULL_FROM_END:
                ...
                this.mPullLabel = context.getString(R.string
                        .pull_to_refresh_from_bottom_pull_label);
                this.mRefreshingLabel = context.getString(R.string
                        .pull_to_refresh_from_bottom_refreshing_label);
                this.mReleaseLabel = context.getString(R.string
            ...
            case PULL_FROM_END:
                if (!attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableEnd)) {
                    if (attrs.hasValue(R.styleable.PullToRefresh_ptrDrawableBottom)) {
                        ...
                        imageDrawable = attrs.getDrawable(R.styleable
