...
public class BaseImageDecoder implements ImageDecoder {
    ...
    protected static final String LOG_SCALE_IMAGE         = "Scale subsampled image (%1$s) to " +
            "%2$s (scale = %3$.5f) [%4$s]";
    protected static final String LOG_SUBSAMPLE_IMAGE     = "Subsample original image (%1$s) to " +
            "%2$s (scale = %3$d) [%4$s]";
    ...
    protected InputStream getImageStream(ImageDecodingInfo decodingInfo) throws IOException {
        return decodingInfo.getDownloader().getStream(decodingInfo.getImageUri(), decodingInfo
    ...
    protected com.nostra13.universalimageloader.core.decode.BaseImageDecoder.ExifInfo
    defineExifOrientation(java.lang.String r9) {
        /*
        r8 = this;
        r7 = 1;
        r4 = 0;
        r3 = 0;
        r1 = new android.media.ExifInterface;	 Catch:{ IOException -> 0x002e }
        r5 = com.nostra13.universalimageloader.core.download.ImageDownloader.Scheme.FILE;
        Catch:{ IOException -> 0x002e }
        r5 = r5.crop(r9);	 Catch:{ IOException -> 0x002e }
        r1.<init>(r5);	 Catch:{ IOException -> 0x002e }
        r5 = "Orientation";
        r6 = 1;
        r2 = r1.getAttributeInt(r5, r6);	 Catch:{ IOException -> 0x002e }
        switch(r2) {
    ...
    L_0x002e:
        ...
        goto L_0x0019;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.nostra13" +
                ".universalimageloader.core.decode.BaseImageDecoder.defineExifOrientation(java" +
                ".lang.String):com.nostra13.universalimageloader.core.decode" +
