...
public class ImageLoader {
    private static final String ERROR_INIT_CONFIG_WITH_NULL      = "ImageLoader configuration can" +
            " not be initialized with null";
    private static final String ERROR_NOT_INIT                   = "ImageLoader must be init with" +
            " configuration before using";
    private static final String ERROR_WRONG_ARGUMENTS            = "Wrong arguments were passed " +
            "to displayImage() method (ImageView reference must not be null)";
    static final         String LOG_DESTROY                      = "Destroy ImageLoader";
    static final         String LOG_INIT_CONFIG                  = "Initialize ImageLoader with " +
            "configuration";
    static final         String LOG_LOAD_IMAGE_FROM_MEMORY_CACHE = "Load image from memory cache " +
            "[%s]";
    public static final  String TAG                              = ImageLoader.class
            .getSimpleName();
    private static final String WARNING_RE_INIT_CONFIG           = "Try to initialize ImageLoader" +
            " which had already been initialized before. To re-init ImageLoader with new " +
            "configuration call ImageLoader.destroy() at first.";
