    ...
    public static Comparator<String> createFuzzyKeyComparator() {
        return new Comparator<String>() {
            public int compare(String key1, String key2) {
                return key1.substring(0, key1.lastIndexOf(MemoryCacheUtils
                        .URI_AND_SIZE_SEPARATOR)).compareTo(key2.substring(0, key2.lastIndexOf
                        (MemoryCacheUtils.URI_AND_SIZE_SEPARATOR)));
            }
        };
    }
