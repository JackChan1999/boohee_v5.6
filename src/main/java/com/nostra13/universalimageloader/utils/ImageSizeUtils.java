...
public final class ImageSizeUtils {
    ...
    public static int computeImageSampleSize(ImageSize srcSize, ImageSize targetSize,
        ...
        int halfHeight;
        switch (1.
        $SwitchMap$com$nostra13$universalimageloader$core$assist$ViewScaleType[viewScaleType
                .ordinal()])
        {
            case 1:
                if (!powerOf2Scale) {
    ...
    private static int considerMaxTextureSize(int srcWidth, int srcHeight, int scale, boolean
            powerOf2) {
