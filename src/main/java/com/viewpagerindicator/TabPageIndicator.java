...
public class TabPageIndicator extends HorizontalScrollView implements PageIndicator {
    ...
    private class TabView extends TextView {
        ...
        public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (TabPageIndicator.this.mMaxTabWidth > 0 && getMeasuredWidth() > TabPageIndicator
                    .this.mMaxTabWidth) {
                super.onMeasure(MeasureSpec.makeMeasureSpec(TabPageIndicator.this.mMaxTabWidth,
                        1073741824), heightMeasureSpec);
            }
        }
    ...
    public TabPageIndicator(Context context, AttributeSet attrs) {
        ...
        this.mTabClickListener = new OnClickListener() {
            public void onClick(View view) {
                ...
                if (oldSelected == newSelected && TabPageIndicator.this.mTabReselectedListener !=
                        null) {
    ...
    private void animateToTab(int position) {
        ...
        this.mTabSelector = new Runnable() {
            public void run() {
                TabPageIndicator.this.smoothScrollTo(tabView.getLeft() - ((TabPageIndicator.this
                        .getWidth() - tabView.getWidth()) / 2), 0);
