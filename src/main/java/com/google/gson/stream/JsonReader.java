...
public class JsonReader implements Closeable {
    ...
    public void beginArray() throws IOException {
        ...
        throw new IllegalStateException("Expected BEGIN_ARRAY but was " + peek() + " at line " +
                getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public void endArray() throws IOException {
        ...
        throw new IllegalStateException("Expected END_ARRAY but was " + peek() + " at line " +
                getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public void beginObject() throws IOException {
        ...
        throw new IllegalStateException("Expected BEGIN_OBJECT but was " + peek() + " at line " +
                getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public void endObject() throws IOException {
        ...
        throw new IllegalStateException("Expected END_OBJECT but was " + peek() + " at line " +
                getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    private int peekKeyword() throws IOException {
        ...
        if ((this.pos + length < this.limit || fillBuffer(length + 1)) && isLiteral(this
                .buffer[this.pos + length])) {
            return 0;
        }
        this.pos += length;
        this.peeked = peeking;
                    ...
                    if (c >= '0' && c <= '9') {
                        if (last != 1 && last != 0) {
                            if (last != 2) {
                                ...
                                int i2 = (value > MIN_INCOMPLETE_INTEGER || (value ==
                                        MIN_INCOMPLETE_INTEGER && newValue < value)) ? 1 : 0;
                                fitsInLong &= i2;
                                value = newValue;
                                break;
                            } else {
    ...
    public String nextName() throws IOException {
        ...
        if (p == 14) {
            ...
            throw new IllegalStateException("Expected a name but was " + peek() + " at line " +
                    getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 0;
    ...
    public String nextString() throws IOException {
        ...
        if (p == 10) {
            ...
            throw new IllegalStateException("Expected a string but was " + peek() + " at line " +
                    getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 0;
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (p == 5) {
            ...
            throw new IllegalStateException("Expected a boolean but was " + peek() + " at line "
                    + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
    }
    ...
    public void nextNull() throws IOException {
        ...
        throw new IllegalStateException("Expected null but was " + peek() + " at line " +
                getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public double nextDouble() throws IOException {
        ...
        if (p == 16) {
            ...
            throw new IllegalStateException("Expected a double but was " + peek() + " at line " +
                    getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 11;
        ...
        throw new MalformedJsonException("JSON forbids NaN and infinities: " + result + " at line" +
                " " + getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
    }
    ...
    public long nextLong() throws IOException {
        ...
        if (p == 16) {
            ...
            throw new IllegalStateException("Expected a long but was " + peek() + " at line " +
                    getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 11;
        ...
        if (((double) parseLong) != asDouble) {
            throw new NumberFormatException("Expected a long but was " + this.peekedString + " at" +
                    " line " + getLineNumber() + " column " + getColumnNumber() + " path " +
                    getPath());
        }
        this.peekedString = null;
        this.peeked = 0;
    ...
    public int nextInt() throws IOException {
        ...
        if (p == 15) {
            ...
            if (this.peekedLong != ((long) result)) {
                throw new NumberFormatException("Expected an int but was " + this.peekedLong + " " +
                        "at line " + getLineNumber() + " column " + getColumnNumber() + " path "
                        + getPath());
            }
            this.peeked = 0;
            int[] iArr = this.pathIndices;
        ...
        if (p == 16) {
            ...
            throw new IllegalStateException("Expected an int but was " + peek() + " at line " +
                    getLineNumber() + " column " + getColumnNumber() + " path " + getPath());
        }
        this.peeked = 11;
        double asDouble = Double.parseDouble(this.peekedString);
        ...
        if (((double) result) != asDouble) {
            throw new NumberFormatException("Expected an int but was " + this.peekedString + " at" +
                    " line " + getLineNumber() + " column " + getColumnNumber() + " path " +
                    getPath());
        }
        this.peekedString = null;
        ...
        while (true) {
            if (p == l) {
                ...
                if (fillBuffer(1)) {
                    ...
                    throw new EOFException("End of input at line " + getLineNumber() + " column "
                            + getColumnNumber());
                }
            }
            int p2 = p + 1;
    ...
    public String toString() {
        return getClass().getSimpleName() + " at line " + getLineNumber() + " column " +
                getColumnNumber();
    }
                    ...
                    if (this.pos + 4 <= this.limit || fillBuffer(4)) {
                        ...
                        while (i2 < end) {
                            ...
                            if (c >= '0' && c <= '9') {
                                ...
                                throw new NumberFormatException("\\u" + new String(this.buffer,
                                        this.pos, 4));
                            } else {
    ...
    private IOException syntaxError(String message) throws IOException {
        throw new MalformedJsonException(message + " at line " + getLineNumber() + " column " +
