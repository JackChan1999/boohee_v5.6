...
final class TreeTypeAdapter<T> extends TypeAdapter<T> {
    ...
    private static class SingleTypeFactory implements TypeAdapterFactory {
        ...
        private SingleTypeFactory(Object typeAdapter, TypeToken<?> exactType, boolean
                matchRawType, Class<?> hierarchyType) {
    ...
    private TreeTypeAdapter(JsonSerializer<T> serializer, JsonDeserializer<T> deserializer, Gson
            gson, TypeToken<T> typeToken, TypeAdapterFactory skipPast) {
    ...
    public T read(JsonReader in) throws IOException {
        ...
        return this.deserializer.deserialize(value, this.typeToken.getType(), this.gson
    ...
    public static TypeAdapterFactory newTypeHierarchyFactory(Class<?> hierarchyType, Object
            typeAdapter) {
