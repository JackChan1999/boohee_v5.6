...
public final class C$Gson$Types {
    ...
    private static final class GenericArrayTypeImpl implements GenericArrayType, Serializable {
        ...
        public boolean equals(Object o) {
            return (o instanceof GenericArrayType) && C$Gson$Types.equals(this,
                    (GenericArrayType) o);
        }
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public boolean equals(Object other) {
            return (other instanceof ParameterizedType) && C$Gson$Types.equals(this,
                    (ParameterizedType) other);
        }

        public int hashCode() {
            return (Arrays.hashCode(this.typeArguments) ^ this.rawType.hashCode()) ^ C$Gson$Types
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public boolean equals(Object other) {
            return (other instanceof WildcardType) && C$Gson$Types.equals(this, (WildcardType)
                    other);
        }

        public int hashCode() {
            return (this.lowerBound != null ? this.lowerBound.hashCode() + 31 : 1) ^ (this
                    .upperBound.hashCode() + 31);
        }
    ...
    public static boolean equals(Type a, Type b) {
        ...
        if (a instanceof ParameterizedType) {
            ...
            if (!(C$Gson$Types.equal(pa.getOwnerType(), pb.getOwnerType()) && pa.getRawType()
                    .equals(pb.getRawType()) && Arrays.equals(pa.getActualTypeArguments(), pb
                    .getActualTypeArguments()))) {
                z = false;
            }
            return z;
            ...
            return C$Gson$Types.equals(((GenericArrayType) a).getGenericComponentType(), (
            ...
            if (!(Arrays.equals(wa.getUpperBounds(), wb.getUpperBounds()) && Arrays.equals(wa
                    .getLowerBounds(), wb.getLowerBounds()))) {
                z = false;
            }
            return z;
            ...
            if (!(va.getGenericDeclaration() == vb.getGenericDeclaration() && va.getName().equals
                    (vb.getName()))) {
                z = false;
            }
            return z;
        ...
        if (toResolve.isInterface()) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (toResolve.isAssignableFrom(interfaces[i])) {
                    return C$Gson$Types.getGenericSupertype(rawType.getGenericInterfaces()[i],
        ...
        if (!rawType.isInterface()) {
            while (rawType != Object.class) {
                ...
                if (toResolve.isAssignableFrom(rawSupertype)) {
                    return C$Gson$Types.getGenericSupertype(rawType.getGenericSuperclass(),
    ...
    static Type getSupertype(Type context, Class<?> contextRawType, Class<?> supertype) {
        ...
        return C$Gson$Types.resolve(context, contextRawType, C$Gson$Types.getGenericSupertype
    ...
    static Type resolveTypeVariable(Type context, Class<?> contextRawType, TypeVariable<?>
        ...
        return ((ParameterizedType) declaredBy).getActualTypeArguments()[C$Gson$Types.indexOf
                (declaredByRaw.getTypeParameters(), unknown)];
    }
