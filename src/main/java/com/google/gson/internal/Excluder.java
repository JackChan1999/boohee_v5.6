...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean
    ...
    private boolean isAnonymousOrLocal(Class<?> clazz) {
        return !Enum.class.isAssignableFrom(clazz) && (clazz.isAnonymousClass() || clazz
                .isLocalClass());
    }
