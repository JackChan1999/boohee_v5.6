...
public class c extends IOException {
    ...
    static c a() {
        return new c("While parsing a protocol message, the input ended unexpectedly in the " +
                "middle of a field.  This could mean either than the input has been truncated or " +
                "that an embedded message misreported its own length.");
    }

    static c b() {
        return new c("CodedInputStream encountered an embedded string or message which claimed to" +
                " have negative size.");
    }
    ...
    static c g() {
        return new c("Protocol message was too large.  May be malicious.  Use CodedInputStream" +
