...
class C40Encoder implements Encoder {
    ...
    private int backtrackOneCharacter(EncoderContext context, StringBuilder buffer, StringBuilder
            removed, int lastCharSize) {
    ...
    private static String encodeToCodewords(CharSequence sb, int startPos) {
        ...
        int v = (((c1 * BitmapUtil.MAX_HEIGHT) + (c2 * 40)) + sb.charAt(startPos + 2)) + 1;
        char cw1 = (char) (v / 256);
        char cw2 = (char) (v % 256);
