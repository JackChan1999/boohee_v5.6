    ...
    public void encode(EncoderContext context) {
        ...
        while (context.hasMoreCharacters()) {
            ...
            if (buffer.length() >= 4) {
                ...
                buffer.delete(0, 4);
                if (HighLevelEncoder.lookAheadTest(context.getMessage(), context.pos,
                        getEncodingMode()) != getEncodingMode()) {
        ...
        try {
            ...
            if (count != 0) {
                if (count == 1) {
                    ...
                    int available = context.getSymbolInfo().getDataCapacity() - context
                            .getCodewordCount();
                ...
                if (restChars <= 2) {
                    ...
                    if (context.getSymbolInfo().getDataCapacity() - context.getCodewordCount() >=
                            3) {
                        restInAscii = false;
