...
public final class MultiFormatOneDReader extends OneDReader {
    ...
    public MultiFormatOneDReader(Map<DecodeHintType, ?> hints) {
        ...
        boolean useCode39CheckDigit = (hints == null || hints.get(DecodeHintType
                .ASSUME_CODE_39_CHECK_DIGIT) == null) ? false : true;
        Collection<OneDReader> readers = new ArrayList();
        if (possibleFormats != null) {
            if (possibleFormats.contains(BarcodeFormat.EAN_13) || possibleFormats.contains
                    (BarcodeFormat.UPC_A) || possibleFormats.contains(BarcodeFormat.EAN_8) ||
