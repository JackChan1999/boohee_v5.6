...
public final class UPCAReader extends UPCEANReader {
    ...
    public Result decodeRow(int rowNumber, BitArray row, int[] startGuardRange,
        ...
        return maybeReturnResult(this.ean13Reader.decodeRow(rowNumber, row, startGuardRange,
                hints));
    }
    ...
    protected int decodeMiddle(BitArray row, int[] startRange, StringBuilder resultString) throws
            NotFoundException {
