...
final class UPCEANExtension5Support {
    private static final int[]         CHECK_DIGIT_ENCODINGS = new int[]{24, 20, 18, 17, 12, 6,
            3, 10, 9, 5};
    ...
    int decodeMiddle(BitArray row, int[] startRange, StringBuilder resultString) throws
        ...
        for (int x = 0; x < 5 && rowOffset < end; x++) {
            int bestMatch = UPCEANReader.decodeDigit(row, counters, rowOffset, UPCEANReader
                    .L_AND_G_PATTERNS);
    ...
    private static String parseExtension5String(String raw) {
        ...
        return currency + String.valueOf(rawAmount / 100) + '.' + (hundredths < 10 ? "0" +
                hundredths : String.valueOf(hundredths));
    }
}
