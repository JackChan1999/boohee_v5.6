...
final class FieldParser {
    ...
    static {
        ...
        r0[3] = new Object[]{Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, VARIABLE_LENGTH, Integer
                .valueOf(20)};
        ...
        r0[10] = new Object[]{Constants.VIA_REPORT_TYPE_QQFAVORITES, VARIABLE_LENGTH, Integer
                .valueOf(20)};
        r0[11] = new Object[]{Constants.VIA_REPORT_TYPE_DATALINE, VARIABLE_LENGTH, Integer
                .valueOf(29)};
        ...
        r0[42] = new Object[]{Channel.QIHU, Integer.valueOf(6)};
    ...
    private static String processFixedAI(int aiSize, int fieldSize, String rawInformation) throws
            NotFoundException {
    ...
    private static String processVariableAI(int aiSize, int variableFieldSize, String
            rawInformation) throws NotFoundException {
        int maxSize;
        String ai = rawInformation.substring(0, aiSize);
