...
public abstract class OneDReader implements Reader {
    public abstract Result decodeRow(int i, BitArray bitArray, Map<DecodeHintType, ?> map) throws
    ...
    protected static float patternMatchVariance(int[] counters, int[] pattern, float
