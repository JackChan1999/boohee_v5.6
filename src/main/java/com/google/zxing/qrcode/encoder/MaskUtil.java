...
final class MaskUtil {
    ...
    static int applyMaskPenaltyRule3(ByteMatrix matrix) {
        ...
        while (y < height) {
            ...
            while (x < width) {
                byte[] arrayY = array[y];
                if (x + 6 < width && arrayY[x] == (byte) 1 && arrayY[x + 1] == (byte) 0 &&
                        arrayY[x + 2] == (byte) 1 && arrayY[x + 3] == (byte) 1 && arrayY[x + 4]
                        == (byte) 1 && arrayY[x + 5] == (byte) 0 && arrayY[x + 6] == (byte) 1 &&
                        (isWhiteHorizontal(arrayY, x - 4, x) || isWhiteHorizontal(arrayY, x + 7,
                                x + 11))) {
                    numPenalties++;
                }
                if (y + 6 < height && array[y][x] == (byte) 1 && array[y + 1][x] == (byte) 0 &&
                        array[y + 2][x] == (byte) 1 && array[y + 3][x] == (byte) 1 && array[y +
                        4][x] == (byte) 1 && array[y + 5][x] == (byte) 0 && array[y + 6][x] ==
                        (byte) 1 && (isWhiteVertical(array, x, y - 4, y) || isWhiteVertical
                        (array, x, y + 7, y + 11))) {
                    numPenalties++;
                }
                x++;
