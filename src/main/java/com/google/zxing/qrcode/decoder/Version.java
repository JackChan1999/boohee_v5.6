...
public final class Version {
    ...
    private static final int[]     VERSION_DECODE_INFO = new int[]{31892, 34236, 39577, 42195,
            48118, 51042, 55367, 58893, 63784, 68472, 70749, 76311, 79154, 84390, 87683, 92361,
            96236, 102084, 102881, 110507, 110734, 117786, 119615, 126325, 127568, 133589,
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(2, Opcodes.INVOKE_VIRTUAL_RANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, 115), new ECB(1, Opcodes
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, 120), new ECB(1, SampleTinkerReport
                .KEY_APPLIED_DEXOPT));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, Opcodes.INVOKE_STATIC), new ECB(4, Opcodes
                .INVOKE_INTERFACE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, Opcodes.INVOKE_VIRTUAL_RANGE), new ECB(4,
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, SampleTinkerReport.KEY_APPLIED_DEXOPT), new
                ECB(5, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, Opcodes.INVOKE_SUPER_RANGE), new ECB(4,
        ...
        iArr = new int[]{6, 30, 58, 86, Opcodes.INVOKE_INTERFACE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, Opcodes.INVOKE_INTERFACE), new ECB(2, 115));
        ...
        iArr = new int[]{6, 34, 62, 90, Opcodes.INVOKE_DIRECT_RANGE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, 122), new ECB(4, Opcodes.NEG_INT));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, Opcodes.INVOKE_SUPER_RANGE), new ECB(10,
                Opcodes.INVOKE_DIRECT_RANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, Opcodes.INVOKE_VIRTUAL_RANGE), new ECB(7,
                Opcodes.INVOKE_SUPER_RANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, 115), new ECB(10, Opcodes
                .INVOKE_VIRTUAL_RANGE));
        ...
        iArr = new int[]{6, 30, 56, 82, 108, Opcodes.LONG_TO_DOUBLE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, 115), new ECB(3, Opcodes
                .INVOKE_VIRTUAL_RANGE));
        ...
        iArr = new int[]{6, 30, 58, 86, Opcodes.INVOKE_INTERFACE, 142};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, 115), new ECB(1, Opcodes
                .INVOKE_VIRTUAL_RANGE));
        ...
        iArr = new int[]{6, 34, 62, 90, Opcodes.INVOKE_DIRECT_RANGE, 146};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, 115), new ECB(6, Opcodes
                .INVOKE_VIRTUAL_RANGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, SampleTinkerReport.KEY_APPLIED_DEXOPT), new
                ECB(7, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, SampleTinkerReport.KEY_APPLIED_DEXOPT), new
                ECB(14, 122));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, 122), new ECB(4, Opcodes.NEG_INT));
        ...
        iArr = new int[]{6, 32, 58, 84, 110, Opcodes.FLOAT_TO_LONG, 162};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, 122), new ECB(18, Opcodes.NEG_INT));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, Opcodes.INVOKE_SUPER_RANGE), new ECB(4,
                Opcodes.INVOKE_DIRECT_RANGE));
        ...
        iArr = new int[]{6, 30, 58, 86, Opcodes.INVOKE_INTERFACE, 142, Opcodes.REM_FLOAT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, Opcodes.INVOKE_DIRECT_RANGE), new ECB(6,
