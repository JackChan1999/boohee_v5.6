...
final class BitMatrixParser {
    ...
    FormatInformation readFormatInformation() throws FormatException {
        ...
        this.parsedFormatInfo = FormatInformation.decodeFormatInformation(formatInfoBits1,
                formatInfoBits2);
        if (this.parsedFormatInfo != null) {
            return this.parsedFormatInfo;
        }
    ...
    Version readVersion() throws FormatException {
        ...
        if (theParsedVersion == null || theParsedVersion.getDimensionForVersion() != dimension) {
            ...
            if (theParsedVersion == null || theParsedVersion.getDimensionForVersion() !=
                    dimension) {
                throw FormatException.getFormatInstance();
            }
    ...
    private int copyBit(int i, int j, int versionBits) {
        return this.mirror ? this.bitMatrix.get(j, i) : this.bitMatrix.get(i, j) ? (versionBits
                << 1) | 1 : versionBits << 1;
    }
    ...
    void remask() {
        if (this.parsedFormatInfo != null) {
            DataMask.forReference(this.parsedFormatInfo.getDataMask()).unmaskBitMatrix(this
                    .bitMatrix, this.bitMatrix.getHeight());
        }
    }
