...
final class DecodedBitStreamParser {
    private static final char[] ALPHANUMERIC_CHARS = new char[]{'0', '1', '2', '3', '4', '5',
    ...
    static DecoderResult decode(byte[] bytes, Version version, ErrorCorrectionLevel ecLevel,
        ...
        return new DecoderResult(bytes, stringBuilder, list, str, symbolSequence, parityData);
    }
    ...
    private static int parseECIValue(BitSource bits) throws FormatException {
        ...
        } else if ((firstByte & Opcodes.SHL_INT_LIT8) == 192) {
