...
public final class SMSMMSResultParser extends ResultParser {
    public SMSParsedResult parse(Result result) {
        ...
        if (!rawText.startsWith("sms:") && !rawText.startsWith("SMS:") && !rawText.startsWith
                ("mms:") && !rawText.startsWith("MMS:")) {
            return null;
        }
        ...
        while (true) {
            ...
            if (comma > lastComma) {
                ...
                return new SMSParsedResult((String[]) numbers.toArray(new String[numbers.size()])
                        , (String[]) vias.toArray(new String[vias.size()]), subject, body);
            }
        }
    }

    private static void addNumberVia(Collection<String> numbers, Collection<String> vias, String
            numberPart) {
