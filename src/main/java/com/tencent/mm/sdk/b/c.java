...
public final class c<K, V> {
    ...
    L_0x0044:
        ...
        goto L_0x0000;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.mm.sdk.b.c" +
                ".trimToSize(int):void");
    }
    ...
    public final synchronized String toString() {
        ...
        synchronized (this) {
            ...
            format = String.format("LruCache[maxSize=%d,hits=%d,misses=%d,hitRate=%d%%]", new
                    Object[]{Integer.valueOf(this.v), Integer.valueOf(this.C), Integer.valueOf(this.D), Integer.valueOf(i)});
        }
        return format;
    }
}
