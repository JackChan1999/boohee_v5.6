...
public final class WXMediaMessage {
    public static final  String ACTION_WXAPPMESSAGE         = "com.tencent.mm.sdk.openapi.Intent" +
            ".ACTION_WXAPPMESSAGE";
    ...
    public static class Builder {
        ...
        public static WXMediaMessage fromBundle(Bundle bundle) {
            ...
            try {
                wXMediaMessage.mediaObject = (IMediaObject) Class.forName(pathOldToNew)
                        .newInstance();
                wXMediaMessage.mediaObject.unserialize(bundle);
                return wXMediaMessage;
            } catch (Exception e) {
                e.printStackTrace();
                a.a(WXMediaMessage.TAG, "get media object from bundle failed: unknown ident " +
                        pathOldToNew + ", ex = " + e.getMessage());
                return wXMediaMessage;
            }
        }
        ...
        public static Bundle toBundle(WXMediaMessage wXMediaMessage) {
            ...
            if (wXMediaMessage.mediaObject != null) {
                bundle.putString(KEY_IDENTIFIER, pathNewToOld(wXMediaMessage.mediaObject.getClass
                        ().getName()));
