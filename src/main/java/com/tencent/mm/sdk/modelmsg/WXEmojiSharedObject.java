...
public class WXEmojiSharedObject implements IMediaObject {
    ...
    public boolean checkArgs() {
        if (!TextUtils.isEmpty(this.packageid) && !TextUtils.isEmpty(this.thumburl) && !TextUtils
                .isEmpty(this.url) && this.packageflag != -1) {
            return true;
        }
        a.a(TAG, "checkArgs fail, packageid or thumburl is invalid");
        return false;
    }
