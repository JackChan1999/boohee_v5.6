...
public class AssistActivity extends Activity {
    ...
    protected void onResume() {
        ...
        if (!intent.getBooleanExtra(SystemUtils.IS_LOGIN, false) && !intent.getBooleanExtra
                (SystemUtils.IS_QQ_MOBILE_SHARE, false)) {
    ...
    protected void onNewIntent(Intent intent) {
        ...
        f.b(TAG, "AssistActivity--onNewIntent--" + (obj == null ? "mAPiObject = null" :
                "mAPiObject != null"));
