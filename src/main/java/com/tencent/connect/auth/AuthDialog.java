...
public class AuthDialog extends Dialog {
            ...
            if (str.startsWith(AuthConstants.REDIRECT_BROWSER_URI)) {
                ...
                if (!this.a.n) {
                    if (parseUrlToJson.optString("fail_cb", null) != null) {
                        ...
                        AuthDialog.a(this.a, this.a.b.indexOf("?") > -1 ? a.b : "?");
                ...
                try {
                    Intent intent = new Intent("android.intent.action.VIEW", Uri.parse(Uri.decode
                            (str.substring("download://".length()))));
    ...
    private class OnTimeListener implements IUiListener {
        ...
        public OnTimeListener(AuthDialog authDialog, String str, String str2, String str3,
        ...
        public void onComplete(Object obj) {
            ...
            g.a().a(this.d + "_H5", SystemClock.elapsedRealtime(), 0, 0, jSONObject.optInt("ret",
                    -6), this.a, false);
            if (this.e != null) {
    ...
    static {
        try {
            ...
            } else if (new File(context.getFilesDir().toString() + "/" + AuthAgent
                    .SECURE_LIB_NAME).exists()) {
    ...
    public void callJs(String str, String str2) {
        this.k.loadUrl("javascript:" + str + SocializeConstants.OP_OPEN_PAREN + str2 + ");void("
