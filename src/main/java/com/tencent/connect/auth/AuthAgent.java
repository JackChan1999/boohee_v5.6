...
public class AuthAgent extends BaseApi {
    ...
    private class FeedConfirmListener implements IUiListener {
        ...
        private View a(Context context, Drawable drawable, String str, OnClickListener
                onClickListener, OnClickListener onClickListener2) {
            ...
            int i2 = (int) (6.0f * f);
            int i3 = (int) (18.0f * f);
            LayoutParams layoutParams = new RelativeLayout.LayoutParams((int) (60.0f * f), (int)
                    (60.0f * f));
            ...
            imageView.setBackgroundColor(Color.rgb(Opcodes.OR_INT_LIT16, Opcodes.OR_INT_LIT16,
                    Opcodes.OR_INT_LIT16));
            imageView.setId(3);
            ...
            layoutParams3.leftMargin = (int) (aj.hA * f);
            ...
            layoutParams3.weight = 1.0f;
            layoutParams3.rightMargin = (int) (aj.hA * f);
            imageView.addView(button, layoutParams3);
            relativeLayout.addView(imageView, layoutParams2);
            LayoutParams layoutParams4 = new FrameLayout.LayoutParams((int) (279.0f * f), (int)
                    (163.0f * f));
            relativeLayout.setPadding((int) (14.0f * f), 0, (int) (12.0f * f), (int) (12.0f * f));
            relativeLayout.setLayoutParams(layoutParams4);
            relativeLayout.setBackgroundColor(Color.rgb(247, SampleTinkerReport
                    .KEY_LOADED_UNCAUGHT_EXCEPTION, 247));
            Drawable paintDrawable = new PaintDrawable(Color.rgb(247, SampleTinkerReport
                    .KEY_LOADED_UNCAUGHT_EXCEPTION, 247));
        ...
        protected void a() {
            HttpUtils.requestAsync(this.b.mToken, this.b.c, "http://appsupport.qq" +
                    ".com/cgi-bin/qzapps/mapp_addapp.cgi", this.b.composeActivityParams(),
                    Constants.HTTP_POST, null);
        }
    ...
    private class TokenListener implements IUiListener {
        ...
        public TokenListener(AuthAgent authAgent, Context context, IUiListener iUiListener,
        ...
        public void onComplete(Object obj) {
            ...
            try {
                ...
                if (string != null) {
                    try {
                        this.d.getSharedPreferences(Constants.PREFERENCE_PF, 0).edit().putString
                                (Constants.PARAM_PLATFORM_ID, string).commit();
                    } catch (Throwable e) {
                        e.printStackTrace();
    ...
    private int a(boolean z, IUiListener iUiListener) {
        ...
        if (isOEM) {
            composeCGIParams.putString(Constants.PARAM_PLATFORM_ID, "desktop_m_qq-" +
                    installChannel + SocializeConstants.OP_DIVIDER_MINUS + DeviceInfoConstant
                    .OS_ANDROID + SocializeConstants.OP_DIVIDER_MINUS + registerChannel +
                    SocializeConstants.OP_DIVIDER_MINUS + businessId);
        } else {
            composeCGIParams.putString(Constants.PARAM_PLATFORM_ID, Constants.DEFAULT_PF);
        }
        String str = (System.currentTimeMillis() / 1000) + "";
        composeCGIParams.putString("sign", SystemUtils.getAppSignatureMD5(Global.getContext(),
                str));
        ...
        stringBuilder.append(ServerSetting.getInstance().getEnvUrl(Global.getContext(),
                ServerSetting.DEFAULT_CGI_AUTHORIZE));
        stringBuilder.append(Util.encodeUrl(composeCGIParams));
        final String stringBuilder2 = stringBuilder.toString();
        final IUiListener tokenListener = new TokenListener(this, Global.getContext(),
                iUiListener, true, false);
        f.b(f.d, "OpenUi, showDialog TDialog");
        ThreadManager.executeOnSubThread(new Runnable(this) {
            final /* synthetic */ AuthAgent c;

            public void run() {
                SystemUtils.extractSecureLib(AuthAgent.SECURE_LIB_FILE_NAME, AuthAgent
                        .SECURE_LIB_NAME, 2);
                this.c.c.runOnUiThread(new Runnable(this) {
                    ...
                    public void run() {
                        new AuthDialog(this.a.c.c, SystemUtils.ACTION_LOGIN, stringBuilder2,
                                tokenListener, this.a.c.mToken).show();
                    }
                });
            }
        });
    ...
    private boolean a(Activity activity, Fragment fragment, boolean z) {
        ...
        if (targetActivityIntent != null) {
            ...
            composeCGIParams.putString(Constants.KEY_APP_NAME, SystemUtils.getAppName(Global
                    .getContext()));
            ...
            if (hasActivityForIntent()) {
                ...
                d.a().a(0, "LOGIN_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), "",
                        Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "");
                return true;
            }
        }
        d.a().a(1, "LOGIN_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), "", Long
                .valueOf(SystemClock.elapsedRealtime()), 0, 1, "startActionActivity fail");
        f.c(f.d, "startActionActivity() -- end");
        return false;
    }
    ...
    protected void b(IUiListener iUiListener) {
        ...
        IRequestListener tempRequestListener = new TempRequestListener(new CheckLoginListener
                (this, iUiListener));
        HttpUtils.requestAsync(this.mToken, Global.getContext(), "https://openmobile.qq" +
                ".com/v3/user/get_info", composeCGIParams, "GET", tempRequestListener);
    }
    ...
    private void a(String str) {
        try {
            ...
            if (!TextUtils.isEmpty(string) && !TextUtils.isEmpty(string2) && !TextUtils.isEmpty
                    (string3)) {
