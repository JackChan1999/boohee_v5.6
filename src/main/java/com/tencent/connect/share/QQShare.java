...
public class QQShare extends BaseApi {
        ...
        if (i == 6) {
            if (SystemUtils.compareQQVersion(activity, SystemUtils.QQ_VERSION_NAME_5_0_0) < 0) {
                ...
                d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(),
                        String.valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1,
                        "shareToQQ, app share is not support below qq5.0.");
                return;
            }
            string4 = String.format(ServerSetting.APP_DETAIL_PAGE, new Object[]{this.mToken
                    .getAppId(), "mqq"});
        ...
        if (Util.hasSDCard() || SystemUtils.compareQQVersion(activity, SystemUtils
            ...
            if (i == 5) {
                if (SystemUtils.compareQQVersion(activity, "4.3.0") < 0) {
                    iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_QQ_VERSION_ERROR,
                            null));
            ...
            if (i != 5) {
                if (TextUtils.isEmpty(string4) || !(string4.startsWith(TimeLinePatterns
                        .WEB_SCHEME) || string4.startsWith("https://"))) {
                    ...
                    iUiListener.onError(new UiError(-6, Constants.MSG_PARAM_TITLE_NULL_ERROR,
                            null));
            ...
            if (TextUtils.isEmpty(string) || string.startsWith(TimeLinePatterns.WEB_SCHEME) ||
                    string.startsWith("https://") || new File(string).exists()) {
            ...
            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                    .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ, " +
                    "image url is emprty or illegal.");
            return;
        }
        iUiListener.onError(new UiError(-6, Constants.MSG_SHARE_NOSD_ERROR, null));
        f.e(a, "shareToQQ sdcard is null--end");
        d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToQQ sdcard" +
                " is null");
    }
    ...
    private void a(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        if (TextUtils.isEmpty(string)) {
                ...
                a.a((Context) activity, string, new AsynLoadImgBack(this) {
                    ...
                    public void saved(int i, String str) {
                        if (i == 0) {
                            ...
                            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.f.mToken
                                    .getAppId(), String.valueOf(0), Long.valueOf(SystemClock
                                    .elapsedRealtime()), 0, 1, Constants.MSG_SHARE_GETIMG_ERROR);
                            return;
                        }
                        this.f.b(r6, r2, r5);
                    }
            ...
            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                    .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, Constants
                    .MSG_SHARE_NOSD_ERROR);
            return;
        } else if (SystemUtils.compareQQVersion(activity, "4.3.0") >= 0) {
            b(activity, bundle, iUiListener);
        } else {
            r2 = bundle;
            r5 = iUiListener;
    ...
    private void b(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        StringBuffer stringBuffer = new StringBuffer
                ("mqqapi://share/to_fri?src_type=app&version=1&file_type=news");
        ...
        if (!TextUtils.isEmpty(string)) {
            stringBuffer.append("&image_url=" + Base64.encodeToString(Util.getBytesUTF8(string),
                    2));
        }
        if (!TextUtils.isEmpty(string7)) {
            stringBuffer.append("&file_data=" + Base64.encodeToString(Util.getBytesUTF8(string7),
                    2));
        }
        ...
        if (!TextUtils.isEmpty(applicationLable)) {
            ...
            stringBuffer.append("&app_name=" + Base64.encodeToString(Util.getBytesUTF8
                    (applicationLable), 2));
        }
        ...
        if (!TextUtils.isEmpty(string5)) {
            stringBuffer.append("&audioUrl=" + Base64.encodeToString(Util.getBytesUTF8(string5),
                    2));
        }
        ...
        if (hasActivityForIntent()) {
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ,
                    Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, "3", "0", this.mViaShareQQType, "0",
                    "1", "0");
            d.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                    .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "");
        } else {
            d.a().a(this.mToken.getOpenId(), this.mToken.getAppId(), Constants.VIA_SHARE_TO_QQ,
                    Constants.VIA_REPORT_TYPE_SHARE_TO_QQ, "3", "1", this.mViaShareQQType, "0",
                    "1", "0");
            d.a().a(1, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                    .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1,
    ...
    private void c(Activity activity, Bundle bundle, IUiListener iUiListener) {
        ...
        StringBuffer stringBuffer = new StringBuffer("http://openmobile.qq" +
                ".com/api/check?page=shareindex.html&style=9");
        if (bundle == null) {
            bundle = new Bundle();
        }
        ...
        startAssistActivity(activity, bundle2, 10103);
        d.a().a(0, "SHARE_CHECK_SDK", Constants.DEFAULT_UIN, this.mToken.getAppId(), String
                .valueOf(0), Long.valueOf(SystemClock.elapsedRealtime()), 0, 1, "shareToH5QQ");
