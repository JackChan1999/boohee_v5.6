...
public class StatService {
    ...
    static void a(Context context, Throwable th) {
        try {
            ...
            if (context == null) {
                i.error((Object) "The Context of StatService.reportSdkSelfException() can not be " +
                        "null!");
                return;
            }
    ...
    public static void commitEvents(Context context, int i) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The maxNumber of StatService.commitEvents() should be -1 or bigger " +
                    "than 0.");
        } else {
            try {
                n.a(context).a(i);
    ...
    public static void reportAppMonitorStat(Context context, StatAppMonitor statAppMonitor) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The StatAppMonitor of StatService.reportAppMonitorStat() can not be" +
                    " null!");
        } else if (statAppMonitor.getInterfaceName() == null) {
            i.error((Object) "The interfaceName of StatAppMonitor on StatService" +
                    ".reportAppMonitorStat() can not be null!");
        } else {
            try {
    ...
    public static void reportError(Context context, String str) {
        ...
        if (context == null) {
            ...
            try {
                e dVar = new d(context, a(context, false), str, 0, StatConfig
    ...
    public static void reportException(Context context, Throwable th) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The Throwable error message of StatService.reportException() can " +
                    "not be null!");
        } else {
    ...
    public static void reportGameUser(Context context, StatGameUser statGameUser) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The account of gameUser on StatService.reportGameUser() can not be " +
                    "null or empty!");
        } else {
            try {
    ...
    public static void setEnvAttributes(Context context, Map<String, String> map) {
        if (map == null || map.size() > 512) {
            i.error((Object) "The map in setEnvAttributes can't be null or its size can't exceed " +
                    "512.");
            return;
        }
        try {
    ...
    public static boolean startStatService(Context context, String str, String str2) {
        if (StatConfig.isEnableStatService()) {
            ...
            if (context == null || str2 == null) {
                str3 = "Context or mtaSdkVersion in StatService.startStatService() is null, " +
                        "please check it!";
                i.error((Object) str3);
                StatConfig.setEnableStatService(false);
                throw new MtaSDkException(str3);
            } else if (k.b(str3) < k.b(str2)) {
                str3 = ("MTA SDK version conflicted, current: " + str3 + ",required: " + str2) +
                        ". please delete the current SDK and download the latest one. official " +
                        "website: http://mta.qq.com/ or http://mta.oa.com/";
                i.error((Object) str3);
                StatConfig.setEnableStatService(false);
                throw new MtaSDkException(str3);
            } else {
    ...
    public static void trackBeginPage(Context context, String str) {
        ...
        if (context == null || str == null || str.length() == 0) {
            i.error((Object) "The Context or pageName of StatService.trackBeginPage() can not be " +
                    "null or empty!");
            return;
        }
        try {
            synchronized (h) {
                if (h.size() >= StatConfig.getMaxParallelTimmingEvents()) {
                    i.error("The number of page events exceeds the maximum value " + Integer
                            .toString(StatConfig.getMaxParallelTimmingEvents()));
                    return;
                }
                f = str;
                if (h.containsKey(f)) {
    ...
    public static void trackCustomBeginEvent(Context context, String str, String... strArr) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The event_id of StatService.trackCustomBeginEvent() can not be null" +
                    " or empty.");
        } else {
            try {
                c cVar = new c(str, strArr, null);
                if (b.containsKey(cVar)) {
                    i.error("Duplicate CustomEvent key: " + cVar.toString() + ", " +
                            "trackCustomBeginEvent() repeated?");
                } else if (b.size() <= StatConfig.getMaxParallelTimmingEvents()) {
                    b.put(cVar, Long.valueOf(System.currentTimeMillis()));
                } else {
                    i.error("The number of timedEvent exceeds the maximum value " + Integer
                            .toString(StatConfig.getMaxParallelTimmingEvents()));
                }
            } catch (Throwable th) {
                i.e((Object) th);
    ...
    public static void trackCustomBeginKVEvent(Context context, String str, Properties properties) {
        ...
        if (context == null) {
            ...
            try {
                ...
                if (b.containsKey(cVar)) {
                    i.error("Duplicate CustomEvent key: " + cVar.toString() + ", " +
                            "trackCustomBeginKVEvent() repeated?");
                } else if (b.size() <= StatConfig.getMaxParallelTimmingEvents()) {
                    b.put(cVar, Long.valueOf(System.currentTimeMillis()));
                } else {
                    i.error("The number of timedEvent exceeds the maximum value " + Integer
    ...
    public static void trackCustomEndEvent(Context context, String str, String... strArr) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The event_id of StatService.trackCustomEndEvent() can not be null " +
                    "or empty.");
        } else {
            try {
                c cVar = new c(str, strArr, null);
                ...
                i.error("No start time found for custom event: " + cVar.toString() + ", lost " +
    ...
    public static void trackCustomEvent(Context context, String str, String... strArr) {
        ...
        if (context == null) {
            ...
            i.error((Object) "The event_id of StatService.trackCustomEvent() can not be null or " +
                    "empty.");
        } else {
            try {
                e bVar = new b(context, a(context, false), str);
    ...
    public static void trackEndPage(Context context, String str) {
        ...
        if (context == null || str == null || str.length() == 0) {
            i.error((Object) "The Context or pageName of StatService.trackEndPage() can not be " +
                    "null or empty!");
            return;
        }
        try {
