...
public class ShareConstants {
    ...
    public static final String CHECK_DEX_INSTALL_FAIL                                =
            "checkDexInstall failed";
    public static final String DEXMODE_JAR                                           = "jar";
    public static final String DEXMODE_RAW                                           = "raw";
    public static final String DEX_IN_JAR                                            = "classes" +
            ".dex";
    public static final String DEX_META_FILE                                         =
            "assets/dex_meta.txt";
    public static final String DEX_OPTIMIZE_PATH                                     = "odex";
    public static final String DEX_PATH                                              = "dex";
    public static final String DEX_SMALLPATCH_INFO_FILE                              =
            "smallpatch_info.ddextra";
    ...
    public static final String NEW_TINKER_ID                                         =
            "NEW_TINKER_ID";
    public static final String NEW_VERSION                                           = "new";
    public static final String OLD_VERSION                                           = "old";
    public static final String PACKAGE_META_FILE                                     =
