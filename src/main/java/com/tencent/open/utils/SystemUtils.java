...
public class SystemUtils {
    ...
    public static boolean isAppSignatureValid(Context context, String str, String str2) {
        ...
        try {
            for (Signature toCharsString : context.getPackageManager().getPackageInfo(str, 64)
                    .signatures) {
    ...
    public static String getAppSignatureMD5(Context context, String str) {
        ...
        try {
            ...
            Signature[] signatureArr = context.getPackageManager().getPackageInfo(packageName,
                    64).signatures;
    ...
    public static boolean isActivityExist(Context context, Intent intent) {
        if (context == null || intent == null || context.getPackageManager()
