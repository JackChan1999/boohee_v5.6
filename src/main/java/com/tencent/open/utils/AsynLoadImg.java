...
public class AsynLoadImg {
    ...
    private Runnable f = new Runnable(this) {
        ...
        public void run() {
            ...
            if (file.exists()) {
                ...
                f.a("AsynLoadImg", "file not exists: download time:" + (System.currentTimeMillis
                        () - this.a.d));
            }
    ...
    public boolean saveFile(Bitmap bitmap, String str) {
        ...
        try {
            ...
            OutputStream bufferedOutputStream2 = new BufferedOutputStream(new FileOutputStream
                    (new File(str2)));
            try {
