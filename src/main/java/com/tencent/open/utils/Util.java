...
public class Util {
    ...
    public static Bundle parseUrl(String str) {
        try {
            URL url = new URL(str.replace("auth://", TimeLinePatterns.WEB_SCHEME));
    ...
    public static String getUserIp() {
        try {
            ...
            while (networkInterfaces != null && networkInterfaces.hasMoreElements()) {
                Enumeration inetAddresses = ((NetworkInterface) networkInterfaces.nextElement())
                        .getInetAddresses();
        ...
        try {
            ...
            if (a) {
                try {
                    ...
                    if (a) {
                        try {
                            a(context, "com.google.android.browser", "com.android.browser" +
                                    ".BrowserActivity", str);
                        } catch (Exception e2) {
                            try {
                                a(context, "com.android.chrome", "com.google.android.apps.chrome" +
                                        ".Main", str);
                            } catch (Exception e3) {
                                return false;
                            }
                    ...
                    try {
                        a(context, "com.android.browser", "com.android.browser.BrowserActivity",
                                str);
                    } catch (Exception e4) {
                        try {
                            a(context, "com.google.android.browser", "com.android.browser" +
            ...
            a = false;
            if (a) {
                a(context, "com.google.android.browser", "com.android.browser.BrowserActivity",
                        str);
            } else {
                a(context, "com.android.browser", "com.android.browser.BrowserActivity", str);
            }
    ...
    public static boolean isMobileQQSupportShare(Context context) {
        try {
            if (SystemUtils.compareVersion(context.getPackageManager().getPackageInfo("com" +
                    ".tencent.mobileqq", 0).versionName, "4.1") >= 0) {
                return true;
            }
            return false;
    ...
    public static String toHexString(String str) {
        ...
        for (int i = 0; i < bytesUTF8.length; i++) {
            stringBuilder.append(i.charAt((bytesUTF8[i] & SocializeConstants
                    .MASK_USER_CENTER_HIDE_AREA) >> 4));
    ...
    public static final String getApplicationLable(Context context) {
        if (context != null) {
            CharSequence applicationLabel = context.getPackageManager().getApplicationLabel
    ...
    public static Bundle composeViaReportParams(String str, String str2, String str3, String
    ...
    public static Bundle composeViaReportParams(String str, String str2, String str3, String
        ...
        bundle.putString(SocializeProtocolConstants.PROTOCOL_KEY_APP_ID, str5);
    ...
    public static Bundle composeHaboCgiReportParams(String str, String str2, String str3, String
