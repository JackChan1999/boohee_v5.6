...
public class OpenConfig {
    ...
    L_0x0087:
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.tencent.open.utils" +
                ".OpenConfig.a(java.lang.String):java.lang.String");
    }
    ...
    private void b() {
        ...
        new Thread(this) {
            ...
            public void run() {
                try {
                    this.b.a(Util.parseJson(HttpUtils.openUrl2(this.b.c, "http://cgi.connect.qq" +
                            ".com/qqconnectopen/openapi/policy_conf", "GET", bundle).response));
                } catch (Exception e) {
                    e.printStackTrace();
                }
                this.b.g = 0;
    ...
    private void c() {
        ...
        if (SystemClock.elapsedRealtime() - this.f >= ((long) (optInt * DateFormatUtils.HOUR))) {
            b();
        }
    }
