...
public class TDialog extends b {
    ...
    private class FbWebViewClient extends WebViewClient {
        ...
        public boolean shouldOverrideUrlLoading(WebView webView, String str) {
            ...
            if (str.startsWith(ServerSetting.getInstance().getEnvUrl((Context) TDialog.this.c.get
    ...
    public TDialog(Context context, String str, String str2, IUiListener iUiListener, QQToken
            qQToken) {
    ...
    private static void d(Context context, String str) {
        if (context != null && str != null) {
            try {
                ...
                } else if (i == 0 && d != null && d.get() != null && ((ProgressDialog) d.get())
                        .isShowing()) {
