...
public class SocialConstants {
    ...
    public static final String ACTIVITY_ASK_GIFT       = "com.tencent.open.agent" +
            ".RequestFreegiftActivity";
    ...
    public static final String ACTIVITY_CHECK_FUNCTION = "com.tencent.open.agent" +
            ".CheckFunctionActivity";
    public static final String ACTIVITY_FRIEND_CHOOSER = "com.tencent.open.agent" +
            ".SocialFriendChooser";
    public static final String ACTIVITY_GRADE          = "com.tencent.open.agent.AppGradeActivity";
    public static final String ACTIVITY_INVITE         = "com.tencent.open.agent" +
            ".AppInvitationActivity";
