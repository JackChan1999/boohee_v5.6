    ...
    public static class b {
        public void call(String str, List<String> list, a aVar) {
            ...
            for (Method method2 : getClass().getDeclaredMethods()) {
                if (method2.getName().equals(str) && method2.getParameterTypes().length == list
                        .size()) {
                    method = method2;
                    break;
                }
            ...
            if (method != null) {
                try {
                    ...
                    f.b(a.b, "-->call, result: " + invoke + " | ReturnType: " + returnType
                            .getName());
    ...
    public static class a {
        ...
        public void a(Object obj) {
            ...
            if (webView != null) {
                ...
                } else if ((obj instanceof Number) || (obj instanceof Long) || (obj instanceof
                        Integer) || (obj instanceof Double) || (obj instanceof Float)) {
                    str = obj.toString();
