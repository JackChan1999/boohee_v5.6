...
final class DistinguishedNameParser {
    ...
    private String nextAT() {
        ...
        if (this.end - this.beg > 4 && this.chars[this.beg + 3] == '.' && ((this.chars[this.beg]
            == 'O' || this.chars[this.beg] == 'o') && ((this.chars[this.beg + 1] == 'I' || this
            .chars[this.beg + 1] == 'i') && (this.chars[this.beg + 2] == 'D' || this.chars[this
            .beg + 2] == 'd')))) {
            this.beg += 4;
        }
        ...
        while (this.pos < this.length) {
            ...
            switch (this.chars[this.pos]) {
                case ' ':
                    ...
                    if (this.pos != this.length && this.chars[this.pos] != ',' && this.chars[this
                            .pos] != '+' && this.chars[this.pos] != ';') {
                        break;
                    }
    ...
    public String findMostSpecific(String attributeType) {
        ...
        do {
            ...
            if (this.chars[this.pos] == ',' || this.chars[this.pos] == ';' || this.chars[this
                    .pos] == '+') {
                this.pos++;
                attType = nextAT();
            } else {
