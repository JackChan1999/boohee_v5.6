...
public final class OkHeaders {
    private static final Comparator<String> FIELD_NAME_COMPARATOR = new
    1();
    ...
    public static void addCookies(Builder builder, Map<String, List<String>> cookieHeaders) {
        for (Entry<String, List<String>> entry : cookieHeaders.entrySet()) {
            ...
            if (("Cookie".equalsIgnoreCase(key) || "Cookie2".equalsIgnoreCase(key)) && !((List)
    ...
    static boolean isEndToEnd(String fieldName) {
        return ("Connection".equalsIgnoreCase(fieldName) || "Keep-Alive".equalsIgnoreCase
                (fieldName) || "Proxy-Authenticate".equalsIgnoreCase(fieldName) ||
                "Proxy-Authorization".equalsIgnoreCase(fieldName) || "TE".equalsIgnoreCase
                (fieldName) || "Trailers".equalsIgnoreCase(fieldName) || "Transfer-Encoding"
                .equalsIgnoreCase(fieldName) || "Upgrade".equalsIgnoreCase(fieldName)) ? false :
                true;
    }
