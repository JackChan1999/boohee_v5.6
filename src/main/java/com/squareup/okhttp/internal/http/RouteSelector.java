...
public final class RouteSelector {
    ...
    private Proxy nextProxy() throws IOException {
        ...
        throw new SocketException("No route to " + this.address.getUriHost() + "; exhausted proxy" +
                " configurations: " + this.proxies);
    }
    ...
    private InetSocketAddress nextInetSocketAddress() throws IOException {
        ...
        throw new SocketException("No route to " + this.address.getUriHost() + "; exhausted inet " +
                "socket addresses: " + this.inetSocketAddresses);
    }
