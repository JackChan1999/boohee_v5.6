...
public class OkHttpClient implements Cloneable {
    ...
    static {
        Internal.instance = new Internal() {
            ...
            public RealConnection get(ConnectionPool pool, Address address, StreamAllocation
                    streamAllocation) {
            ...
            public HttpUrl getHttpUrlChecked(String url) throws MalformedURLException,
    ...
    private OkHttpClient(OkHttpClient okHttpClient) {
        ...
        this.internalCache = this.cache != null ? this.cache.internalCache : okHttpClient
                .internalCache;
