...
public class MyHttpStack extends HurlStack {
    ...
    public MyHttpStack(UrlRewriter urlRewriter) {
        this(urlRewriter, null);
    }

    public MyHttpStack(UrlRewriter urlRewriter, SSLSocketFactory sslSocketFactory) {
    ...
    private static boolean hasResponseBody(int requestMethod, int responseCode) {
        return (requestMethod == 4 || ((100 <= responseCode && responseCode < 200) ||
                responseCode == 204 || responseCode == SampleTinkerReport.KEY_LOADED_MISSING_LIB)
        ) ? false : true;
    }
