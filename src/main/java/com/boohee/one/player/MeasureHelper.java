                ...
                if (widthSpecMode == Integer.MIN_VALUE && heightSpecMode == Integer.MIN_VALUE) {
                    ...
                    switch (this.mCurrentAspectRatio) {
                        case 4:
                            ...
                            if (this.mVideoRotationDegree == 90 || this.mVideoRotationDegree ==
                                    270) {
                        ...
                        default:
                            displayAspectRatio = ((float) this.mVideoWidth) / ((float) this
                                    .mVideoHeight);
                            if (this.mVideoSarNum > 0 && this.mVideoSarDen > 0) {
                                displayAspectRatio = (((float) this.mVideoSarNum) *
                                        displayAspectRatio) / ((float) this.mVideoSarDen);
                                break;
                            }
                    }
