...
public class CookSearchActivity$$ViewInjector<T extends CookSearchActivity> implements Injector<T> {
    public void inject(Finder finder, final T target, Object source) {
        ...
        View view = (View) finder.findRequiredView(source, R.id.search_tip, "field " +
                "'tv_search_tip' and method 'onClick'");
