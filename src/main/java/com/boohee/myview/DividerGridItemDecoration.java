...
public class DividerGridItemDecoration extends ItemDecoration {
    ...
    public void drawHorizontal(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.mDivider.setBounds(child.getLeft() - params.leftMargin, top, (child.getRight() +
                    params.rightMargin) + this.mDivider.getIntrinsicWidth(), top + this.mDivider
                    .getIntrinsicHeight());
    ...
    public void drawVertical(Canvas c, RecyclerView parent) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            this.mDivider.setBounds(left, child.getTop() - params.topMargin, right, child
                    .getBottom() + params.bottomMargin);
            this.mDivider.draw(c);
        }
    }
