...
public final class a {
    ...
    public static final String c = "2014052600006128";
    public static final String d = "1";
    public static final String e = "15.0.4";
    public static final String f = "h.a.3.0.4";
    public static final String g = "15.0.4";
    ...
    public static final String j = "sdklite://h5quit?result=";
    public static final String k = "sdklite://h5quit";
    public static final String l = "http://m.alipay.com/?action=h5quit";
    public static final String m = "&end_code=";
    public static final String n = "&return_url=";
