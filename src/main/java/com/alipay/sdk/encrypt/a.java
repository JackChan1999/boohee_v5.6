    ...
    public static String a(byte[] bArr) {
        ...
        while (i4 < i3) {
            ...
            if ((b2 & g) == 0) {
                ...
                b = (byte) ((b2 >> 4) ^ SocializeConstants.MASK_USER_CENTER_HIDE_AREA);
            }
            if ((b3 & g) == 0) {
                length = (byte) (b3 >> 6);
            } else {
                length = (byte) ((b3 >> 6) ^ SampleTinkerReport.KEY_LOADED_EXCEPTION_DEX);
            }
            int i8 = i5 + 1;
            cArr[i5] = j[i6];
            i6 = i8 + 1;
        ...
        if (i2 == 8) {
            ...
            length = (b & g) == 0 ? (byte) (b >> 4) : (byte) ((b >> 4) ^ SocializeConstants.MASK_USER_CENTER_HIDE_AREA);
            i = i5 + 1;
            cArr[i5] = j[i3];
            i3 = i + 1;
