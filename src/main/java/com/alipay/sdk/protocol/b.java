...
public final class b {
    ...
    public static List<b> a(JSONObject jSONObject) {
        ...
        if (!TextUtils.isEmpty(optString)) {
            strArr = optString.split(DnspodFree.IP_SPLIT);
        }
        ...
        if (split != null) {
            for (indexOf = 0; indexOf < split.length; indexOf++) {
                if (!TextUtils.isEmpty(split[indexOf])) {
                    arrayList.add(split[indexOf].trim().replaceAll("'", "").replaceAll(com.alipay.sdk.sys.a.e, ""));
                }
            }
        }
    ...
    private static String[] b(String str) {
        ...
        return str.split(DnspodFree.IP_SPLIT);
    }
