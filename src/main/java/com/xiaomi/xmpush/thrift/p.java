...
public class p implements Serializable, Cloneable, b<p, a> {
    ...
    static {
        ...
        org.apache.thrift.meta_data.b.a(p.class, k);
    }
    ...
    public boolean a(p pVar) {
        ...
        a = b();
        a2 = pVar.b();
        if ((a || a2) && (!a || !a2 || !this.b.a(pVar.b))) {
            return false;
        }
        a = c();
        a2 = pVar.c();
        if ((a || a2) && (!a || !a2 || !this.c.equals(pVar.c))) {
            return false;
        }
        a = d();
        a2 = pVar.d();
        if ((a || a2) && (!a || !a2 || !this.d.equals(pVar.d))) {
            return false;
        }
        a = e();
        a2 = pVar.e();
        if ((a || a2) && (!a || !a2 || !this.e.a(pVar.e))) {
            return false;
        }
        a = f();
        a2 = pVar.f();
        if ((a || a2) && (!a || !a2 || this.f != pVar.f)) {
            return false;
        }
        a = g();
        a2 = pVar.g();
        if ((a || a2) && (!a || !a2 || !this.g.equals(pVar.g))) {
            return false;
        }
        a = i();
        a2 = pVar.i();
        if ((a || a2) && (!a || !a2 || !this.h.equals(pVar.h))) {
            return false;
        }
        a = j();
        a2 = pVar.j();
        if ((a || a2) && (!a || !a2 || !this.i.equals(pVar.i))) {
            return false;
        }
        a = l();
        a2 = pVar.l();
        return !(a || a2) || (a && a2 && this.j.equals(pVar.j));
    }
    ...
    public int b(p pVar) {
        ...
        if (b()) {
            compareTo = org.apache.thrift.c.a(this.b, pVar.b);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        compareTo = Boolean.valueOf(c()).compareTo(Boolean.valueOf(pVar.c()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (c()) {
            compareTo = org.apache.thrift.c.a(this.c, pVar.c);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (d()) {
            compareTo = org.apache.thrift.c.a(this.d, pVar.d);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (e()) {
            compareTo = org.apache.thrift.c.a(this.e, pVar.e);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        compareTo = Boolean.valueOf(f()).compareTo(Boolean.valueOf(pVar.f()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (f()) {
            compareTo = org.apache.thrift.c.a(this.f, pVar.f);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (g()) {
            compareTo = org.apache.thrift.c.a(this.g, pVar.g);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        ...
        if (i()) {
            compareTo = org.apache.thrift.c.a(this.h, pVar.h);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        compareTo = Boolean.valueOf(j()).compareTo(Boolean.valueOf(pVar.j()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (j()) {
            compareTo = org.apache.thrift.c.a(this.i, pVar.i);
            if (compareTo != 0) {
                return compareTo;
            }
        }
        compareTo = Boolean.valueOf(l()).compareTo(Boolean.valueOf(pVar.l()));
        if (compareTo != 0) {
            return compareTo;
        }
        if (l()) {
            compareTo = org.apache.thrift.c.a(this.j, pVar.j);
            if (compareTo != 0) {
                return compareTo;
            }
        }
