...
public class a implements e {
    ...
    public a(String str, String str2, String[] strArr, String[] strArr2, String str3, List<a>
            list) {
        this.a = str;
        this.b = str2;
        this.c = strArr;
    ...
    public String d() {
        ...
        if (!TextUtils.isEmpty(this.b)) {
            stringBuilder.append(" ").append("xmlns=").append(com.alipay.sdk.sys.a.e).append(this
                    .b).append(com.alipay.sdk.sys.a.e);
        }
        if (this.c != null && this.c.length > 0) {
            for (int i = 0; i < this.c.length; i++) {
                if (!TextUtils.isEmpty(this.d[i])) {
                    stringBuilder.append(" ").append(this.c[i]).append("=\"").append(g.a(this
                            .d[i])).append(com.alipay.sdk.sys.a.e);
                }
            }
        }
