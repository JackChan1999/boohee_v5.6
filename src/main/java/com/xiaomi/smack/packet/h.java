...
public class h {
    ...
    public String d() {
        ...
        stringBuilder.append("<error code=\"").append(this.a).append(com.alipay.sdk.sys.a.e);
        if (this.b != null) {
        ...
        if (this.e != null) {
            stringBuilder.append("<text xml:lang=\"en\" " +
    ...
    public String toString() {
        ...
        stringBuilder.append(SocializeConstants.OP_OPEN_PAREN).append(this.a).append
