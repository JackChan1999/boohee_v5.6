...
public class w {
    ...
    public static class b {
        ...
        public long a() {
            return 1000 * (((long) ((Math.random() * 20.0d) - 10.0d)) + ((long) ((this.n + 1) *
                    15)));
        }
        ...
        public void a(c cVar, int i, int i2, String str, String str2) {
            ...
            if (this.m != cVar) {
                com.xiaomi.channel.commonutils.logger.b.a(String.format("update the client %7$s " +
                        "status. %1$s->%2$s %3$s %4$s %5$s %6$s", new Object[]{this.m, cVar, a(i)
                        , y.a(i2), str, str2, this.h}));
                this.m = cVar;
            }
            if (this.k == null) {
                com.xiaomi.channel.commonutils.logger.b.d("status changed while the client " +
    ...
    public synchronized Collection<b> c(String str) {
        return !this.b.containsKey(str) ? new ArrayList() : ((HashMap) ((HashMap) this.b.get(str)
        ).clone()).values();
    }
