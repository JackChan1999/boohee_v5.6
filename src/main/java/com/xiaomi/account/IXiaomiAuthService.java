...
public interface IXiaomiAuthService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IXiaomiAuthService {
        private static final String DESCRIPTOR                        = "com.xiaomi.account" +
                ".IXiaomiAuthService";
        ...
        private static class Proxy implements IXiaomiAuthService {
            ...
            public Bundle getMiCloudUserInfo(Account account, Bundle options) throws
                    RemoteException {
            ...
            public Bundle getMiCloudAccessToken(Account account, Bundle options) throws
                    RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            public Bundle getSnsAccessToken(Account account, Bundle options) throws
                    RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
