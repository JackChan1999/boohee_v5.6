...
public abstract class HttpUtils {
    ...
    static int a(int i, int i2, int i3) {
        return ((((((i2 + 200) / 1448) * 132) + CloseFrame.UNEXPECTED_CONDITION) + i2) + i) + i3;
    }
    ...
    public static String a(Context context, String str, List<c> list, HttpProcessor
            httpProcessor, boolean z) {
        if (d.d(context)) {
            try {
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        ...
                        if (TextUtils.isEmpty(str2)) {
                            if (fallback != null) {
                                fallback.a(str3, System.currentTimeMillis() - currentTimeMillis,
                                        (long) a(httpProcessor, str3, arrayList2, str2), null);
                            }
                            str3 = str2;
                            str2 = str3;
                            ...
                            fallback.a(str3, System.currentTimeMillis() - currentTimeMillis,
                                    (long) a(httpProcessor, str3, arrayList2, str2));
                            return str2;
                        }
                    } catch (Exception e) {
                        if (fallback != null) {
                            fallback.a(str3, System.currentTimeMillis() - currentTimeMillis,
                                    (long) a(httpProcessor, str3, arrayList2, str2), e);
                        }
                        e.printStackTrace();
                        str3 = str2;
                    }
