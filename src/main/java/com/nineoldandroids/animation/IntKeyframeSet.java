...
class IntKeyframeSet extends KeyframeSet {
    ...
    public int getIntValue(float fraction) {
        if (this.mNumKeyframes == 2) {
            ...
            return ((Number) this.mEvaluator.evaluate(fraction, Integer.valueOf(this.firstValue),
                    Integer.valueOf(this.lastValue))).intValue();
            ...
            return this.mEvaluator == null ? ((int) (((float) (nextValue - prevValue)) *
                    intervalFraction)) + prevValue : ((Number) this.mEvaluator.evaluate
                    (intervalFraction, Integer.valueOf(prevValue), Integer.valueOf(nextValue)))
                    .intValue();
            ...
            while (i < this.mNumKeyframes) {
                ...
                if (fraction < nextKeyframe.getFraction()) {
                    ...
                    return this.mEvaluator == null ? ((int) (((float) (nextValue - prevValue)) *
                            intervalFraction)) + prevValue : ((Number) this.mEvaluator.evaluate
                            (intervalFraction, Integer.valueOf(prevValue), Integer.valueOf
                                    (nextValue))).intValue();
                } else {
