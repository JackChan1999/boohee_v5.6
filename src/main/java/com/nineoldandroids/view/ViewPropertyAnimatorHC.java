...
class ViewPropertyAnimatorHC extends ViewPropertyAnimator {
    ...
    private class AnimatorEventListener implements AnimatorListener,
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            PropertyBundle propertyBundle = (PropertyBundle) ViewPropertyAnimatorHC.this
            ...
            if (valueList != null) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    ViewPropertyAnimatorHC.this.setValue(values.mNameConstant, values.mFromValue
                            + (values.mDeltaValue * fraction));
                }
            }
            v = (View) ViewPropertyAnimatorHC.this.mView.get();
            if (v != null) {
