...
class ViewPropertyAnimatorPreHC extends ViewPropertyAnimator {
    ...
    private              AnimatorEventListener             mAnimatorEventListener = new
    ...
    private class AnimatorEventListener implements AnimatorListener,
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            PropertyBundle propertyBundle = (PropertyBundle) ViewPropertyAnimatorPreHC.this
                    .mAnimatorMap.get(animation);
            ...
            if (valueList != null) {
                ...
                for (int i = 0; i < count; i++) {
                    ...
                    ViewPropertyAnimatorPreHC.this.setValue(values.mNameConstant, values
                            .mFromValue + (values.mDeltaValue * fraction));
                }
            }
            v = (View) ViewPropertyAnimatorPreHC.this.mView.get();
            if (v != null) {
    ...
    private static class PropertyBundle {
        ...
        boolean cancel(int propertyConstant) {
            if (!((this.mPropertyMask & propertyConstant) == 0 || this.mNameValuesHolder == null)) {
                ...
                for (int i = 0; i < count; i++) {
                    if (((NameValuesHolder) this.mNameValuesHolder.get(i)).mNameConstant ==
                            propertyConstant) {
