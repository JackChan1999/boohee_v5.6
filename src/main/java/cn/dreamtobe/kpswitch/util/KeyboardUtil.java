...
public class KeyboardUtil {
    ...
    private static class KeyboardStatusListener implements OnGlobalLayoutListener {
        ...
        KeyboardStatusListener(boolean isFullScreen, boolean isTranslucentStatus, boolean isFitSystemWindows, ViewGroup contentView, IPanelHeightTarget panelHeightTarget, OnKeyboardShowingListener listener) {
    ...
    public static void attach(Activity activity, IPanelHeightTarget target, OnKeyboardShowingListener listener) {
        ...
        contentView.getViewTreeObserver().addOnGlobalLayoutListener(new KeyboardStatusListener(ViewUtil.isFullScreen(activity), ViewUtil.isTranslucentStatus(activity), ViewUtil.isFitsSystemWindows(activity), contentView, target, listener));
    }
