...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b0 & 128) == 0) {
            ...
            byteCount = 2;
            min = 128;
        } else if ((b0 & SocializeConstants.MASK_USER_CENTER_HIDE_AREA) == Opcodes.SHL_INT_LIT8) {
            codePoint = b0 & 15;
            byteCount = 3;
            min = 2048;
        } else if ((b0 & 248) == SocializeConstants.MASK_USER_CENTER_HIDE_AREA) {
            codePoint = b0 & 7;
            byteCount = 4;
            min = 65536;
        } else {
        ...
        if (this.size < ((long) byteCount)) {
            throw new EOFException("size < " + byteCount + ": " + this.size + " (to read code point prefixed 0x" + Integer.toHexString(b0) + SocializeConstants.OP_CLOSE_PAREN);
        }
        int i = 1;
        while (i < byteCount) {
            ...
            while (i < endIndex) {
                ...
                if (c < 128) {
                    ...
                    if (c > 56319 || low < 56320 || low > 57343) {
                        ...
                        writeByte((codePoint >> 18) | SocializeConstants.MASK_USER_CENTER_HIDE_AREA);
    ...
    public String toString() {
        ...
        try {
            MessageDigest md5 = MessageDigest.getInstance(Coder.KEY_MD5);
